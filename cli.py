...
builtins.third_eye_args = args
builtins.third_eye_user = args.user
...
if os.getenv("SUDO_USER") is None:
	...
	print("\tsudo third_eye " + " ".join(sys.argv[1:]))
	sys.exit(1)

# Beond this point the user can't change anymore, if we still have root as user we need to abort
if args.user == "root":
	print("Can't run third_eye commands as root, please run this command with the --user flag")
	sys.exit(1)
