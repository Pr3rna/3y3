...
if builtins.third_eye_args.argument is None:
	print("Please add a 0 (enable) or a 1 (disable) as an argument")
	sys.exit(1)

# Translate the argument to the right string
if builtins.third_eye_args.argument == "1" or builtins.howdy_args.argument.lower() == "true":
	out_value = "true"
elif builtins.third_eye_args.argument == "0" or builtins.howdy_args.argument.lower() == "false":
	out_value = "false"
else:
...
if builtins.third_eye_args.argument == "1":
	print("third_eye has been disabled")
else:
	print("third_eye has been enabled")
